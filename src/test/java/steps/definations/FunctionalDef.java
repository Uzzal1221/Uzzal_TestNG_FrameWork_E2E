...
import project.web.elements.MasterPageFactory;
public class FunctionalDef extends ParentClass{
	...
	public void verify_that_home_page_is_visible_successfully() {
		...
		pf.getLoginIn(prop.getProperty("UserName"), prop.getProperty("Password"));
